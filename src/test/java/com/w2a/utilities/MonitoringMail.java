...
public class MonitoringMail {   //An object of this class is created in the custom listeners to facilitate sending test results from the jenkins to emails upon execution.
